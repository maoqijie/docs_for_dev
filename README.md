...
[![Version](https://img.shields.io/badge/version-1.0.0-blue.svg)](https://github.com/yourusername/docs-for-dev)
...
#### Linux
- **AppImage**: `codex-chat_0.1.3_amd64.AppImage`（便携版）
- **Deb**: `codex-chat_0.1.3_amd64.deb`（Debian/Ubuntu）

#### Windows
- **MSI**: `Codex Chat_0.1.3_x64_en-US.msi`

#### macOS
- **DMG**: `Codex Chat_0.1.3_x64.dmg`
- **App**: `Codex Chat.app`
